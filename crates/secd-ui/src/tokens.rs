//! Cobalt ledger palette. Hex values are locked.

pub const CANVAS: &str = "#F4F6F8";
pub const SURFACE: &str = "#FFFFFF";
pub const INK: &str = "#12141A";
pub const MUTED: &str = "#5C6570";
pub const LINE: &str = "#D8DEE6";
pub const COBALT: &str = "#1E4D8C";
pub const DANGER: &str = "#9B1C2C";
pub const OK: &str = "#1F6B4A";
