...
use secd_ui::{
    ...
    remove_passkey_enabled, render_account, render_gate, render_register, session_revoke_delete,
    session_revoke_path, AccountView, AuthMethod, FieldAction, GateKind, GateQuery, LayoutMode,
    PasskeyRow, RegisterView, Remembered, SecretItem, SessionInfo, SessionRow, BREAKPOINT_PX,
...
fn T_WEB_ACCOUNT_REVOKE() {
    ...
    assert!(
        session_revoke_delete("sess-nuc").starts_with("DELETE /api/v1/sessions/"),
