...
Host: `secd.imabee.com` (`192.168.101.122`) tcp 443. AppSynergy CA only. Version floor 0.1.18. What runs is the newest release, which the pipeline tags above that.
